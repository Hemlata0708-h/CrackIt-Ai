...
import { askAi } from "../../../services/open.Router.services.js";
...
export const generateQuestion = async (req, res) => {
  try {
    ...
    if (!role || !experience || !mode) {
      return res
        .status(400)
        .json({ message: "Role, xperience and mode are required" });
    }
...
export const getMyInterviews = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: " failed to find  interview" });
  }
};
