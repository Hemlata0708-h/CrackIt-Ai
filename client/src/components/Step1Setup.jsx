        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Enter role (e.g. 2 years)"
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition"
            ...
            {!analysisDone && (
              ...
              >
                <FaFileUpload className="text-4x1 mx-auto text-green-600 mb-3" />
            ...
            {analysisDone && (
              <motion.div
                ...
                className=" bg-gray-50 border □ border-gray-200 rounded-xl p space-y-4"
              >
